...
import com.example.timeplantest.weight.timeselectview.viewinterface.IRectDraw
...
import com.example.timeplantest.weight.timeselectview.viewinterface.IRectView
import com.example.timeplantest.weight.timeselectview.viewinterface.IRectViewRectManger
 ...
 * @author 985892345
 * @date 2021/3/20
 * @description [com.example.timeplantest.weight.timeselectview.layout.ChildLayout]之下
 */
                ...
                if (rect != null) {
                    when (mData.mCondition) {
                        ...
                        EMPTY_AREA, EMPTY_SLIDE_UP, EMPTY_SLIDE_DOWN -> {
                            ...
                            val bean = TSViewTaskBean(mIRectView.getDate(), name, startTime, endTime, diffTime, borderColor, insideColor)

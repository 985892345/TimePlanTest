package com.example.timeplantest.weight.timeselectview.utils
...
import com.example.timeplantest.weight.timeselectview.layout.*
import com.example.timeplantest.weight.timeselectview.layout.view.RectImgView
import com.example.timeplantest.weight.timeselectview.layout.view.RectView
import com.example.timeplantest.weight.timeselectview.layout.view.SeparatorLineView
import com.example.timeplantest.weight.timeselectview.utils.rect.RectDraw
import com.example.timeplantest.weight.timeselectview.utils.rect.RectManger
import com.example.timeplantest.weight.timeselectview.viewinterface.*
import java.util.*
 ...
 */
class TSViewObjectsManger(context: Context, data: TSViewInternalData, firstDate: String) {
    ...
    inner class My1IVpLayout : IVpLayout {
        ...
        override fun notifyAllRectRefresh() {
            this@TSViewObjectsManger.notifyAllRectViewRedraw()
        }
    ...
    inner class My6IRectView : IRectView {
        ...
        override fun getDate(): String {
            return TSViewTimeUtil.getDate(mFirstDate, mVpPosition)
        }
    }
}